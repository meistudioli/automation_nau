module.exports = {
    ...
    DE_CAPTCHA_URL: 'http://c5.devstg.ah.yahoo.com:4080/captcha/decode',
    DID_URL: 'https://tw.otplogin.reg.yahoo.com/device_id/did_reverify.php?srv=AUCTION&f=f&done=',
    WWSID_URL: 'http://auction.yql.yahoo.com:4080/v1/public/yql?q=select%20*%20from%20ecauction.common.wssid&format=json',
    BARGAIN_ON: 'https://tw.bid.yahoo.com/api/bargain/v1/bargains',
    BARGAIN_ACCEPT: 'https://tw.bid.yahoo.com/api/bargain/v1/bargains/{1}/messages',
