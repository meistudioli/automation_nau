Feature: [booth][booth search]
    ...
    Background: visit "booth - seller_pp_b2c"
        Given I visit "booth - seller_pp_b2c"
    ...
    Scenario: 表頭 - 促銷標籤 必須移除
        ...
        Given switch to dummy - "my_booth_it_uat.html"
    ...
    Scenario: 競標品標籤必須要顯示
        ...
        Given switch to dummy - "my_booth_it_uat_bidding.html"
